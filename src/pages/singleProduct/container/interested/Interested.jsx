...
export default function Interested() {
    ...
    const calculatePages = () => {
        let arrayLength = Math.ceil(trendingData.length / 4)
        ...
        <section className='bg-gray-300 py-20'>
            <div className='w-4/5 sm:w-3/4 md:w-2/3 mx-auto mb-20'>
                <div className='flex items-center justify-between mb-14'>
                    <h1 className='font-bold text-2xl'>You may be interested in</h1>
                ...
                <div className='grid grid-cols-1 sm:grid-cols-4 gap-7 overflow-x-auto'>
                    {data?.map((item, index) => (
                        <ProductCard
                            item={item}
                            index={index}
